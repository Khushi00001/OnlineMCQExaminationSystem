...
if ($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM l5 WHERE id = '$id'";
    ...
    $sql = "UPDATE l5 SET question='$question', option1='$option1', option2='$option2', option3='$option3', option4='$option4', answer='$answer' WHERE id='$id'";
    if (mysqli_query($conn, $sql)) {
        echo "Question updated successfully!<br>";
        echo "<script>window.location.href='addlevel5.php?id=$id';</script>";
    } else {
