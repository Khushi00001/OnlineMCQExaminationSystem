...
<body>
    ...
    <nav class="side-nav">
        <ul>
            <li><a href="" class="btn"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
            <li><a href="#" class="btn"><i class="bi bi-plus-circle-fill"></i> Add Questions</a></li>
            <li><a href="#" class="btn"><i class="fas fa-users"></i> View Users</a></li>
