...
if ($_SERVER["REQUEST_METHOD"] === "GET" && isset($_GET['id'])) {
    ...
    $sql = "SELECT * FROM loksewa WHERE id = '$id'";
    ...
    $sql = "UPDATE loksewa SET question='$question', option1='$option1', option2='$option2', option3='$option3', option4='$option4', answer='$answer' WHERE id='$id'";
    if (mysqli_query($conn, $sql)) {
        echo "Question updated successfully!<br>";
        echo "<script>window.location.href='addlevelone.php?id=$id';</script>";
    } else {
