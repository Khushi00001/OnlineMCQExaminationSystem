...
<body>
	...
	<a href="addlevel3.php"><button  id="add-question-btn" class="btn"><i class="bi bi-plus-lg"></i> Add Questions</button></a>
	...
	if(isset($_POST['add'])) {
		...
		$answer = $_POST['answer'];
		$sql = "INSERT INTO l3 (id, question, option1, option2, option3, option4, answer) VALUES ('$id', '$question', '$option1', '$option2', '$option3', '$option4', '$answer')";
