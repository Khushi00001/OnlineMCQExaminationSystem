...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($result_user->num_rows > 0) {
        ...
        $exam_name = "Loksewa Level 1"; // Replace "Your Exam Name" with the actual subject name
        ...
        if ($conn->query($insert_query) === TRUE) {
            ...
            $update_query = "UPDATE result SET score = '$marks' WHERE result_id = '$result_id'";
            ...
            <?php if (count($incorrectQuestions) > 0): ?>
                <div class="incorrect-questions">
                    ...
                    <?php foreach ($incorrectQuestions as $questionId => $correctAnswer): ?>
                        <?php
                        $sql = "SELECT * FROM Loksewa WHERE id = '$questionId'";
                        $result = mysqli_query($conn, $sql);
